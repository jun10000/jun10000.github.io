...
自分の好きなように創るからこそ、大半の既製品のように"規格化"された（マジョリティに媚びを売った）ものにわざわざ自分から合わせる必要がなく、結果的に満足度が高くてストレスの少ない"作品"を愛せるようになります。  
もう一つは、設計、製作、テストプロセスなどは頭を使うし、"何が必要か"などをしっかりと考えます。  
今の人達を見ると、既製品の割とどうでもいい機能などに対して多額の金を払い、それを有難がっているように見えるんですよね。  
要は、"何が必要か"、"何にワクワクするか"などを分かっていない気がする。  
"自作"をすることによって、そういったことを考えるようにもなる効果がある気がします。  
かくいう私も、昔は無駄に金を使っていた愚か者でしたので、人のことはあまり言えませんが・・・  

今、私は酔っぱらったふりをしています。もうしばらくお付き合いください。  
（酒は飲んでおりません。普通の人たちなら話さないようなことを、世間の目を気にせずに敢えてズバズバと書いているだけです。）  
